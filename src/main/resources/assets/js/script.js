...
$(document).ready(function(){
    $('.slider_4').slick({
        ...
        easing:'_linear_',          //defualt
        infinite: true, 
        nextArrow: '.slider_4_arrows_2',
        prevArrow: '.slider_4_arrows_1',           //defualt
        autoplay:true,              
        autoplaySpeed: 5000,
        pauseOnFocus:true,          //defualt
        pauseOnHover:true,          //defualt
        ...
        // ],
        mobileFirst: false,         //defualt min-width isk false --- max-widts=h
        appendArrows: $('.slider_4_arrows'), //html-i mej sarqum es div et classi anunov  kam urish anunov u iran pahum dra mej
        // appendDots: $('.appendArrows'),   //html-i mej sarqum es div et classi anunov  kam urish anunov u iran pahum dra mej
    });    
});
...
$(".our_aa").on('click', function(){
    $('.ourpart_1').css('display', 'none')
    $('.ourpart_2').css('display', 'flex')
    $('.our_a').removeClass('our_active')
    $('.our_aa').addClass('our_active')
  })



  $(".our_a").on('click', function(){
    $('.ourpart_2').css('display', 'none')
    $('.ourpart_1').css('display', 'flex')
    $('.our_aa').removeClass('our_active')
    $('.our_a').addClass('our_active')
  })

$(".lm_1").on('click', function(){
    $('.lm_1').removeClass('lm_1_active')
    $(this).addClass('lm_1_active')
})
